...
public class MyNewServer {
    ...
    private final static Logger logger = Logger.getLogger(MyNewServer.class.getName());
        ...
        try {
            ...
            while (true) {
                ...
                while (it.hasNext()) {
                    ...
                    ServerSocketChannel selectServerSocketChannel =  (ServerSocketChannel) readyKey.channel();
